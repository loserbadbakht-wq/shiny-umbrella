...
// and per-chat command menus READ FROM BOTFATHER every time.
// ============================================================
...
// Fetches FRESH every call, so BotFather changes take effect immediately.
 ...
 *
 * Read-only: never writes to BotFather's storage.
 */
...
async function handleStart(env, chatId) {
    ...
    // Fetch BotFather's commands fresh and apply as per-chat override.
...
async function handleCallbackQuery(env, callbackQuery) {
    ...
    if (data && data.startsWith('lang:')) {
        ...
        // 2. Fetch BotFather's commands fresh for that language and
        //    apply them as a per-chat override.
        await applyBotFatherCommandsToChat(env, chatId, lang);
