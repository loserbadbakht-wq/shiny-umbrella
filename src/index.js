 ...
 *
 * Column layout:
 *   - "columns=1,6" gives the Show column 6× the width of the Time column,
 *     which makes the table fill as much horizontal space as Telegram allows.
 *   - nowrap on the time cell keeps HH:MM on a single line, so the browser
 *     doesn't shrink the column unnecessarily.
 */
function formatDaySchedule(day, entries, lang) {
    ...
    // Wide layout: 1 unit for time, 6 units for the show title.
