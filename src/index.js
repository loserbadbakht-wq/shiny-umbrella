...
// ============= FIXED LISTFILTERED HANDLER WITH COPYABLE PERSIAN =============
async function listFilteredHandler(ctx) {
    ...
    try {
        ...
        if (lang === 'fa') {
            // Persian version - use code blocks for IDs
            message += `📋 فیلتر شده در ${groupName} (${total} عدد)\n\n`;
            message += `_برای کپی کردن هر آیدی، روی آن فشار دهید و نگه دارید_\n\n`;
        ...
        // Send with parse_mode for both languages (now Persian has code blocks)
