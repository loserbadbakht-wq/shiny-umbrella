 ...
 * So the Worker reads env.BOT_TOKEN (not a hardcoded var).
 *
 ...
 *
 * Player count policy (fixed at /begin):
...
export class GameRoom {
  ...
  async handleUpdate(update, workerUrl) {
    // Ignore updates sent by ANY bot — prevents re-processing our own dice.
