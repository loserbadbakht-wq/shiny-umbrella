...
function hourlyMessage(t) {
  ...
  // Show the "you can stop it" hint when the target is LOCKED:
  //   - resolved user (userId set), OR
  //   - unresolved username (username set, userId null → t.me/username link)
  // Plain-text targets (displayName only) → anyone can stop, no hint.
