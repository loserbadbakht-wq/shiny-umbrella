...
async function listFilteredHandler(ctx) {
    ...
    try {
        ...
        if (lang === 'fa') {
            // Persian version - SIMPLIFIED, no special characters
            message = '📋 Filtered Media in ' + groupName + ' (' + total + ' total)\n\n';
            message += 'Tap and hold any ID to copy it\n\n';
        ...
        // Try to send with markdown for both
        try {
            ...
            console.error('[ERROR] Markdown failed, sending plain text:', markdownError);
